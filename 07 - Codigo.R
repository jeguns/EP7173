...
datos7_sample5$Class |> table() |> prop.table()
datos7$Class |> table() |> prop.table()
...
datos7$Class = as.factor(datos7$Class) # es necesario convertir para que funcione UBL
library(UBL) 
mod_12        = UBL::CNNClassif(Class~., datos7, Cl = "all") 
datos7_12     = mod_12[[1]] 
